...
const ListDemo = () => {
    ...
    useEffect(() => {
        console.log('dataViewValue: ', dataViewValue);
    }, [dataViewValue]);

    const changeList = () => {
        setDataViewValue(Object.assign([], dataViewValue));
    }
    ...
    const dataviewGridItem = (data: Demo.Product) => {
        return (
            <div className="col-12 lg:col-4" onClick={(e) => { data.selected = !data.selected; changeList() }} >
                <div className="card m-3 border-1 surface-border" style={{ backgroundColor: data.selected ? '#22C55E' : '' }}>
                    ...
                    <div className="flex align-items-center justify-content-between">
                        <span className="text-2xl font-semibold">{data.price} zł</span>
